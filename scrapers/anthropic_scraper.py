                ...
                for row in rows[1:]:
                    ...
                    if 'deprecated model' in ' '.join(headers).lower():
                        ...
                        for i, cell in enumerate(cells):
                            ...
                            if i == 0 and any(model_prefix in cell.lower() for model_prefix in 
                            ...
                            elif i < len(headers) and ('retire' in header or 'deprecat' in header):
                    ...
                    if model_name and (shutdown_date or deprecated_date):
                        ...
                        if shutdown_date and 'Not sooner than' in shutdown_date:
                            date_match = re.search(r'(\d{4}-\d{2}-\d{2})', shutdown_date)
                            if date_match:
                        ...
                        item = DeprecationItem(
                            ...
                            announcement_date=deprecated_date or announcement_date or "",
